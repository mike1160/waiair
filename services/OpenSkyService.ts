...
function mapOpenSkyFlight(raw: any, dir: 'dep' | 'arr') {
  ...
  return {
    ...
    arrivalTime: arrIso && arrIso !== depIso ? arrIso : '',
    departureTime: depIso,
    scheduledDeparture: depIso,
    scheduledArrival: arrIso && arrIso !== depIso ? arrIso : '',
    estimatedArrival: arrIso && arrIso !== depIso ? arrIso : '',
    actualDeparture: dir === 'dep' ? depIso : '',
    actualArrival: dir === 'arr' && !airborne ? arrIso : '',
    boardSide: dir === 'arr' ? 'arrival' : 'departure',
    gate: '',
    terminal: '',
    baggage: '',
    runway: '',
