...
import FlightPassportSection from './FlightPassportSection';
...
async function enrichBaggageFromFids(flight:Flight, destIata:string):Promise<Flight>{
  ...
  try{
    ...
    const hit=flights.find(f=>flightSlug(f.number)===slug);
      ...
      <AnimatedFlashList
        ...
        ListHeaderComponent={
          <BoardHeader
            ...
            error={error}
            onRetry={()=>load(airport.iata, flightTab)}
        ...
        onEndReachedThreshold={BOARD_END_REACHED_THRESHOLD}
          ...
          ListFooterComponent={
            tab==='myflights'&&!globalMode ? (
            <>
              <FlightPassportSection
                colors={C}
                refreshKey={passportRefresh}
                onSharePassport={()=>setPassportShareOpen(true)}
              />
