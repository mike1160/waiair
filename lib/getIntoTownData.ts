/**
 * Which ride-hailing apps and public transport an airport has. Pure data and lookups — no React Native — so
 * the moment builder (lib/tripMoments.ts) can use it under `node --test`. The deep-link openers stay in
 * ./getIntoTown.ts, which re-exports everything here so existing imports keep working.
 */
