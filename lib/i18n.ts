...
const EN = {
  ...
  onboardingAlertsSubtitle: 'Get instant alerts for gate changes, delays and boarding — before anyone else knows',
  onboardingPickupTitle: 'Pick someone up?',
  onboardingPickupSubtitle: 'We tell you exactly when to leave home so you arrive right as they walk out',
  onboardingHowTitle: "Here's how it works",
  onboardingHowArrivesTitle: 'Arrives / Departs',
  onboardingHowArrivesBody: 'Switch between arrivals and departures',
  onboardingHowTrackedTitle: 'Tracked',
  onboardingHowTrackedBody: "Flights you're following — tap the bell on any flight to track it",
  onboardingHowRadarTitle: 'Radar',
  onboardingHowRadarBody: 'See all planes in the air around you live',
  onboardingHowSettingsTitle: 'Settings',
  onboardingHowSettingsBody: 'Change language, airport and notifications',
...
const NL_STRINGS: Record<string, string> = {
  ...
  onboardingAlertsSubtitle: 'Direct meldingen bij gatewijzigingen, vertragingen en boarding — vóór de rest',
  onboardingPickupTitle: 'Iemand ophalen?',
  onboardingPickupSubtitle: 'We vertellen precies wanneer je vertrekt, zodat je aankomt als zij naar buiten lopen',
  onboardingHowTitle: 'Zo werkt het',
  onboardingHowArrivesTitle: 'Aankomsten / Vertrek',
  onboardingHowArrivesBody: 'Wissel tussen aankomsten en vertrek',
  onboardingHowTrackedTitle: 'Gevolgd',
  onboardingHowTrackedBody: 'Vluchten die je volgt — tik op het bel-icoon bij een vlucht',
  onboardingHowRadarTitle: 'Radar',
  onboardingHowRadarBody: 'Bekijk live alle vliegtuigen in de lucht om je heen',
  onboardingHowSettingsTitle: 'Instellingen',
  onboardingHowSettingsBody: 'Taal, luchthaven en meldingen aanpassen',
