...
const st = StyleSheet.create({
  ...
  invitePrimaryBtnTxt: { color: '#0D1B2E', fontSize: 17, fontWeight: '800' },
  ...
  copyBtnTxt: { color: '#0D1B2E', fontSize: 16, fontWeight: '800' },
  ...
  addFlightBtnTxt: { color: '#0D1B2E', fontSize: 17, fontWeight: '800' },
});
